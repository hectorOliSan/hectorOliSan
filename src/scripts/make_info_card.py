...
# ===========================================================================
HOST = "hector"   # shown as  hector@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role", "Full Stack Developer"),
    ("kv", "Focus", "Web Development · Cross-Platform Applications | AI · Big Data"),
    ("kv", "Based", "Canary Islands, Spain"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "JavaScript · TypeScript · Python · PHP"),
    ("kv", "Frameworks", "Astro · React · FastAPI · Laravel"),
    ("kv", "Data", "SQL · Qlik"),
]
